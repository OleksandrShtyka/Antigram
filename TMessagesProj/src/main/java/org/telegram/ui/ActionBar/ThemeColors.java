...
public class ThemeColors {
    ...
    public static final int TELEGRAM_COLOR = 0xFF007AFF;        // -14509328
    public static final int TELEGRAM_COLOR_TEXT = 0xFF0055CC;   // -14054705
    public static final int DEFAULT_BLACK_TEXT = 0xFF000000;   // -15065823
    ...
    public static int[] createDefaultColors() {
        ...
        defaultColors[key_dialogTextBlue] = 0xFF007AFF;
        defaultColors[key_dialogTextBlue2] = 0xFF007AFF;
        defaultColors[key_dialogTextBlue4] = 0xFF007AFF;
        ...
        defaultColors[key_windowBackgroundWhiteGrayText] = 0xFF8E8E93;
        defaultColors[key_windowBackgroundWhiteGrayText2] = 0xFF8E8E93;
        defaultColors[key_windowBackgroundWhiteGrayText3] = 0xFFAEAEB2;
        defaultColors[key_windowBackgroundWhiteGrayText4] = 0xFF8E8E93;
        defaultColors[key_windowBackgroundWhiteGrayText5] = 0xFFAEAEB2;
        defaultColors[key_windowBackgroundWhiteGrayText6] = 0xFF8E8E93;
        defaultColors[key_windowBackgroundWhiteGrayText7] = 0xFFC7C7CC;
        ...
        defaultColors[key_windowBackgroundGray] = 0xFFF2F2F7;
        defaultColors[key_windowBackgroundGrayShadow] = 0xff000000;
        defaultColors[key_emptyListPlaceholder] = 0xff73787b;
        defaultColors[key_divider] = 0xFFC6C6C8;
        defaultColors[key_graySection] = 0xFFF2F2F7;
        defaultColors[key_graySectionText] = 0xFF8E8E93;
        ...
        defaultColors[key_actionBarDefault] = 0xFFF9F9F9;
        ...
        defaultColors[key_chats_name] = 0xFF000000;
        defaultColors[key_chats_nameArchived] = 0xFF000000;
        defaultColors[key_chats_secretName] = 0xff00a60e;
        defaultColors[key_chats_secretIcon] = 0xff19b126;
        defaultColors[key_chats_pinnedIcon] = 0xFFC7C7CC;
        defaultColors[key_chats_message] = 0xFF8E8E93;
        defaultColors[key_chats_messageArchived] = 0xFFAEAEB2;
        defaultColors[key_chats_message_threeLines] = 0xFF8E8E93;
        ...
        defaultColors[key_chats_date] = 0xFF8E8E93;
        defaultColors[key_chats_date_bold] = 0xFF8E8E93;
        defaultColors[key_chats_pinnedOverlay] = 0x08000000;
        defaultColors[key_chats_tabletSelectedOverlay] = 0x0f000000;
        defaultColors[key_chats_sentCheck] = 0xFF8E8E93;
        defaultColors[key_chats_sentReadCheck] = 0xFF007AFF;
        defaultColors[key_chats_sentClock] = 0xFFAEAEB2;
        defaultColors[key_chats_sentError] = 0xffd55252;
        defaultColors[key_chats_sentErrorIcon] = 0xffffffff;
        defaultColors[key_chats_verifiedBackground] = 0xFF007AFF;
        defaultColors[key_chats_verifiedCheck] = 0xffffffff;
        defaultColors[key_chats_muteIcon] = 0xFFC7C7CC;
        ...
        defaultColors[key_chat_outBubble] = 0xFF007AFF;
        defaultColors[key_chat_outBubbleGradientSelectedOverlay] = 0x14000000;
        defaultColors[key_chat_outBubbleSelected] = 0xFF0055CC;
        defaultColors[key_chat_outBubbleShadow] = 0xFF1A67CC;
        ...
        defaultColors[key_chat_outMediaIconSelected] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_messageLinkOut] = 0xFFCCE5FF;
        ...
        defaultColors[key_chat_outForwardedNameText] = 0xCCFFFFFF;
        defaultColors[key_chat_inPsaNameText] = 0xff5a9c39;
        defaultColors[key_chat_outPsaNameText] = 0xCCFFFFFF;
        defaultColors[key_chat_inViaBotNameText] = TELEGRAM_COLOR_TEXT;
        defaultColors[key_chat_outViaBotNameText] = 0xCCFFFFFF;
        defaultColors[key_chat_stickerViaBotNameText] = 0xffffffff;
        defaultColors[key_chat_inReplyLine] = 0xff599fd8;
        defaultColors[key_chat_outReplyLine] = 0xCCFFFFFF;
        defaultColors[key_chat_outReplyLine2] = 0x80FFFFFF;
        ...
        defaultColors[key_chat_outReplyMessageText] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_outPreviewLine] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_outContactPhoneText] = 0xCCFFFFFF;
        defaultColors[key_chat_outContactPhoneSelectedText] = 0xCCFFFFFF;
        defaultColors[key_chat_mediaProgress] = 0xffffffff;
        defaultColors[key_chat_inAudioProgress] = 0xffffffff;
        defaultColors[key_chat_outAudioProgress] = 0xFFFFFFFF;
        defaultColors[key_chat_inAudioSelectedProgress] = 0xffeff8fe;
        defaultColors[key_chat_outAudioSelectedProgress] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_outAudioPerformerText] = 0xCCFFFFFF;
        defaultColors[key_chat_outAudioPerformerSelectedText] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_outAudioSeekbar] = 0x4DFFFFFF;
        defaultColors[key_chat_outAudioCacheSeekbar] = 0x26FFFFFF;
        defaultColors[key_chat_inAudioSeekbarSelected] = 0xffbcdee8;
        defaultColors[key_chat_outAudioSeekbarSelected] = 0x80FFFFFF;
        ...
        defaultColors[key_chat_outVoiceSeekbar] = 0x4DFFFFFF;
        defaultColors[key_chat_inVoiceSeekbarSelected] = 0xffbcdee8;
        defaultColors[key_chat_outVoiceSeekbarSelected] = 0x80FFFFFF;
        ...
        defaultColors[key_chat_outFileProgress] = 0x4DFFFFFF;
        defaultColors[key_chat_inFileProgressSelected] = 0xffcbeaf6;
        defaultColors[key_chat_outFileProgressSelected] = 0x26FFFFFF;
        ...
        defaultColors[key_chat_outFileBackground] = 0x26FFFFFF;
        defaultColors[key_chat_inFileBackgroundSelected] = 0xffcbeaf6;
        defaultColors[key_chat_outFileBackgroundSelected] = 0x1AFFFFFF;
        ...
        defaultColors[key_chat_outLinkSelectBackground] = 0x33FFFFFF;
        ...
        defaultColors[key_chat_outLocationIcon] = 0xCCFFFFFF;
        defaultColors[key_chat_inContactBackground] = TELEGRAM_COLOR;
        defaultColors[key_chat_inContactIcon] = 0xffffffff;
        defaultColors[key_chat_outContactBackground] = 0x26FFFFFF;
        defaultColors[key_chat_outContactIcon] = 0xFFFFFFFF;
        ...
        defaultColors[key_chat_outLoaderSelected] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_outQuote] = 0xCCFFFFFF;
        ...
        defaultColors[key_chat_outBubbleLocationPlaceholder] = 0x1e1A67CC;
